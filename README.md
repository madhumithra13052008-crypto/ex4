...
## OUTPUT
![alt text](mapapp/mapperapp/static/map.png)
![alt text](<mapapp/mapperapp/static/kolathur screenshot.png>)
![alt text](<mapapp/mapperapp/static/perambur screenshot.png>)
![alt text](<mapapp/mapperapp/static/Ayyanavaram screenshot.png>)
![alt text](<mapapp/mapperapp/static/spectrum screenshot.png>)
![alt text](<mapapp/mapperapp/static/merdian screenshot.png>)
